...
void setup(){
  ...
  cMile = circumference * 1.578 / 100000; // inches to miles 
  pinMode(reed, INPUT);
...
void displayDist() { //Hard code 1 decimal place 
  int len = getIntLen((int)dist);
  lcd.setCursor(8, 0);
  lcd.print("D:");
  lcd.setCursor(13-len, 0);
  lcd.print((int)dist);
  lcd.setCursor(13, 0);
  lcd.print(".");
  lcd.setCursor(14, 0);
  lcd.print((int)((int)(dist*10) % 10)); // Get 1st decimal degit 
}
